...
//		p11.getCategorias().addAll(Arrays.asList(cat7));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "cassimiro.daniel@gmail.com", "36378912377", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "agendaslice@gmail.com", "98393580498", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("8165985698", "81998996454"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Cde da Boa Vista", "800", "9 Andar", "Centro", "5420000", cli2, c2);
