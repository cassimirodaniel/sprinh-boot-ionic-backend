...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "12585685456", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("985687458", "985478569"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38542548", cli1, c1);
		Endereco e2 = new Endereco(null, "Avendida Matos", "105", "Sala 800", "Centro", "38485788", cli1, c2);
